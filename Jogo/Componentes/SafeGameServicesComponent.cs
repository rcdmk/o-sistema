...
{
    /// <summary>
    /// Componente de Gaseservices que evita erros no Windows referentes a device.Reset() causando dispose em texturas
    /// (por kevin.gadd - retirado do projeto "fracture - Open source C# game development framework" - http://code.google.com/p/fracture/ - sobre a MIT License)
    /// </summary>
    ...
    public class RealGuideProvider : IGuideProvider
    {
        ...
        {
            get { return Guide.IsScreenSaverEnabled; }
            set { Guide.IsScreenSaverEnabled = value; }
        }
        ...
        {
            get { return Guide.NotificationPosition; }
            set { Guide.NotificationPosition = value; }
        }

        public bool SimulateTrialMode
        {
            get { return Guide.SimulateTrialMode; }
            set { Guide.SimulateTrialMode = value; }
        }
    }
    ...
    public static class PluggableGuide
    {
        ...
        {
            get { return Provider.IsScreenSaverEnabled; }
            set { Provider.IsScreenSaverEnabled = value; }
        }

        public static bool IsTrialMode
        {
            get { return Provider.IsTrialMode; }
        }

        public static bool IsVisible
        {
            get { return Provider.IsVisible; }
        }

        public static NotificationPosition NotificationPosition
        {
            get { return Provider.NotificationPosition; }
            set { Provider.NotificationPosition = value; }
        }

        public static bool SimulateTrialMode
        {
            get { return Provider.SimulateTrialMode; }
            set { Provider.SimulateTrialMode = value; }
        }
